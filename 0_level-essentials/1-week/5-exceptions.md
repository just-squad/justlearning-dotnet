...
## 1. Основы исключений: Что это и зачем нужно?
...
## 2. Обработка исключений: try-catch-finally
...
## 5. Проблемы производительности и памяти
...
## 6. Минимизация влияния на память
...
## 7. Альтернатива исключениям: Паттерн Result
...
## 8. Best Practices: Золотые правила работы с исключениями
