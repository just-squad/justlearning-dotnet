...
## 1. Основы async/await: Зачем они нужны?
...
## 2. Как работает async/await внутри: Машина состояний
...
## 3. Потоки (Threads) vs Задачи (Tasks)
...
## 4. Task Scheduler: Диспетчер задач
...
## 5. Производительность: Task vs Thread
...
## 6. Важные нюансы асинхронности

### 6.1. async void — только для событий
...
## 7. Шаблоны проектирования для асинхронности

### 7.1. Отмена операций (CancellationToken)
...
## 8. Когда использовать асинхронность?
